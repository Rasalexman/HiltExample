...
public abstract class Hilt_MainFragment<B extends ViewDataBinding, VM extends ViewModel> extends BaseBindingFragment<B, VM> implements GeneratedComponentManager<Object> {
  ...
  public final Object generatedComponent() {
    return UnsafeCasts.<Hilt_MainFragment>unsafeCast(this).componentManager().generatedComponent();
  }
  ...
  protected void inject() {
    ((MainFragment_GeneratedInjector) UnsafeCasts.<Hilt_MainFragment>unsafeCast(this).generatedComponent()).injectMainFragment(UnsafeCasts.<MainFragment>unsafeCast(this));
  }
