...
public abstract class Hilt_LoginFragment<B extends ViewDataBinding, VM extends ViewModel> extends BaseBindingFragment<B, VM> implements GeneratedComponentManager<Object> {
  ...
  public final Object generatedComponent() {
    return UnsafeCasts.<Hilt_LoginFragment>unsafeCast(this).componentManager().generatedComponent();
  }
  ...
  protected void inject() {
    ((LoginFragment_GeneratedInjector) UnsafeCasts.<Hilt_LoginFragment>unsafeCast(this).generatedComponent()).injectLoginFragment(UnsafeCasts.<LoginFragment>unsafeCast(this));
  }
