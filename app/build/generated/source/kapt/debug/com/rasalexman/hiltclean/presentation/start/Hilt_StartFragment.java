...
public abstract class Hilt_StartFragment<VM extends ViewModel> extends BaseFragment<VM> implements GeneratedComponentManager<Object> {
  ...
  public final Object generatedComponent() {
    return UnsafeCasts.<Hilt_StartFragment>unsafeCast(this).componentManager().generatedComponent();
  }
  ...
  protected void inject() {
    ((StartFragment_GeneratedInjector) UnsafeCasts.<Hilt_StartFragment>unsafeCast(this).generatedComponent()).injectStartFragment(UnsafeCasts.<StartFragment>unsafeCast(this));
  }
